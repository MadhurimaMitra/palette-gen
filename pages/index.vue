<template>
  <section @keyup.space="handleClick()" class="flex flex-col items-center bg-slate-200 h-screen py-20">
    ...
    <button @click="handleClick()" class="bg-purple text-white text-lg font-medium px-28 py-4 rounded mb-4">Generate palette</button>
    <p class="mb-10 text-sm">Or just press the "Spacebar" to generate new palettes.</p>
    <div class="flex items-center gap-1.5 bg-white rounded-[32px] px-4 py-1 text-sm">
